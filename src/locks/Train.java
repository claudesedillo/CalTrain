...
/*TODO:
 * remove passenger from arraylist of passengers
 * move train runnable code to another class?
 */
public class Train implements Runnable{
	...
	public void run(){
		...
		do{
			...
			//offload passengers that are going down on this station
			int counter = 0;
			for(Passenger p: passengers){
				if(p.getOutStation() == this.inStation.getStationNumber()){
					System.out.println("Passengers " + p.getCount() + ": Now Leaving Train");
